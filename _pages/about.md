...
### Specializations
- **Quantitative Analysis:** Time series modeling, forecasting, optimization
- **High-Performance Computing:** Parallel algorithms, distributed systems, MPI
- **Data Engineering:** Large-scale pipelines, real-time analytics, ETL
- **Statistical Modeling:** Spatial statistics, uncertainty quantification, Bayesian methods